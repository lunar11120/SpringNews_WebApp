...
public class testServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<h1>Servlet testServlet at " + news01.getNewsid() + "</h1>");
            out.println("<h1>Servlet testServlet at " + news01.getReporterid()+ "</h1>");
            out.println("<h1>Servlet testServlet at " + news01.getStatus()+ "</h1>");
            out.println("<h1>Servlet testServlet at " + news01.getWho_update_id() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
