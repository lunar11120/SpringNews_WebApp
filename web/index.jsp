...
<html>
    ...
    <body>
        <table width="1000" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>
            <td width="999" height="131" bgcolor="#FFCC00"><img src="imagespring/banner1.jpg" width="1000" height="131"></td>
          </tr>
          <tr>
              ...
              <tr>
                <td bgcolor="#999999"><form name="form1" method="post" action="Login">
                  <table width="413" border="0" align="center" cellpadding="2" cellspacing="2">
                    <tr>
                      <td colspan="3"><img src="imagespring/register01.jpg" width="248" height="58"></td>
                    </tr>
                    <tr>
          ...
          <tr>
            <td bgcolor="#FFFFFF"><table width="853" border="0" cellspacing="2" cellpadding="2">
              <tr>
                <td width="95"><img src="imagespring/logo1.jpg" width="104" height="104"></td>
