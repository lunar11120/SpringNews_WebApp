...
public class AddCommentServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<h1>newid " + cnewsid + "</h1>");
            out.println("<h1>comm1 " + comment1 + "</h1>");
            out.println("<h1> <a href=\"ReporterServlet\">Back to Main page Reporter</a></h1>");
            out.println("<h1> <a href=\"McrServlet\">Back to MCR</a></h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
